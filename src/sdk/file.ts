...
export class File {
    ...
    async deleteMulti(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFilesApiV1WorkspacesWorkspaceNameFilesDeleteRequest(req);
        }
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.DeleteFilesApiV1WorkspacesWorkspaceNameFilesDeleteSecurity(
                security
            );
        }
    ...
    async deleteSingle(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFileApiV1WorkspacesWorkspaceNameFilesFileIdDeleteRequest(
                req
            );
        }
    ...
    async get(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFileApiV1WorkspacesWorkspaceNameFilesFileIdGetRequest(req);
        }
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetFileApiV1WorkspacesWorkspaceNameFilesFileIdGetSecurity(
                security
            );
        }
        const client: AxiosInstance = utils.createSecurityClient(
    ...
    async getMetaData(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFileMetaApiV1WorkspacesWorkspaceNameFilesFileIdMetaGetRequest(
                req
            );
        }
    ...
    async list(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListFilesApiV1WorkspacesWorkspaceNameFilesGetRequest(req);
        }
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ListFilesApiV1WorkspacesWorkspaceNameFilesGetSecurity(
                security
            );
        }
        const client: AxiosInstance = utils.createSecurityClient(
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.filePagination = utils.objectToClass(httpRes?.data, shared.FilePagination);
                }
                break;
            case httpRes?.status == 422:
                if (utils.matchContentType(contentType, `application/json`)) {
    ...
    async upload(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UploadFileApiV1WorkspacesWorkspaceNameFilesPostRequest(req);
        }
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.UploadFileApiV1WorkspacesWorkspaceNameFilesPostSecurity(
                security
            );
        }
        const client: AxiosInstance = utils.createSecurityClient(
