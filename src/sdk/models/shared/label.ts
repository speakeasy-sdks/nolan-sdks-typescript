 ...
 */
export class LabelHaystackFilters extends SpeakeasyBase {}

export class LabelMeta extends SpeakeasyBase {}
...
export class Label extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "filters" })
    @Type(() => LabelHaystackFilters)
    filters?: LabelHaystackFilters;
