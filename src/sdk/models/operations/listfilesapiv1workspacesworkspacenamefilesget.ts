...
export class ListFilesApiV1WorkspacesWorkspaceNameFilesGetRequest extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=after_file_id" })
    afterFileId?: string;
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=after_value" })
    afterValue?: any;
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=meta_key" })
    metaKey?: string;
     ...
     * @deprecated this field will be removed in a future release, please migrate away from it as soon as possible
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=meta_value" })
    metaValue?: string;
