...
export class UploadFileApiV1WorkspacesWorkspaceNameFilesPostRequest extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=file_name" })
    fileName?: string;
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=write_mode" })
...
export class UploadFileApiV1WorkspacesWorkspaceNameFilesPostResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    responseUploadFileApiV1WorkspacesWorkspaceNameFilesPost?: Record<string, string>;
