...
export class PipelineSearchHistoryApiV1WorkspacesWorkspaceNamePipelinesPipelineNameSearchHistoryGetSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class PipelineSearchHistoryApiV1WorkspacesWorkspaceNamePipelinesPipelineNameSearchHistoryGetRequest extends SpeakeasyBase {
    /**
    ...
    /**
     * The name of the pipeline that you want to fetch the search history for.
     */
...
export class PipelineSearchHistoryApiV1WorkspacesWorkspaceNamePipelinesPipelineNameSearchHistoryGetResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
