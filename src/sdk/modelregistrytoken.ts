...
export class ModelRegistryToken {
  ...
  async get(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetTokenApiV1ModelRegistryTokensProviderGetRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetTokenApiV1ModelRegistryTokensProviderGetSecurity(
          security
        );
    }
  ...
  async getTokenDeprecated(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/model_registry_token";

    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetTokenDeprecatedApiV1ModelRegistryTokenGetSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async list(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/model_registry_tokens";

    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ListTokensApiV1ModelRegistryTokensGetSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async remove(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.RemoveTokenApiV1ModelRegistryTokensProviderDeleteRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.RemoveTokenApiV1ModelRegistryTokensProviderDeleteSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async removeTokenDeprecated(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.RemoveTokenDeprecatedApiV1ModelRegistryTokenDeleteSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async save(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.SaveTokenApiV1ModelRegistryTokensProviderPostRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.SaveTokenApiV1ModelRegistryTokensProviderPostSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async saveTokenDeprecated(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.SaveTokenDeprecatedApiV1ModelRegistryTokenPostSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async update(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.UpdateTokenApiV1ModelRegistryTokensProviderPutRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.UpdateTokenApiV1ModelRegistryTokensProviderPutSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async updateTokenDeprecated(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.UpdateTokenDeprecatedApiV1ModelRegistryTokenPutSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
