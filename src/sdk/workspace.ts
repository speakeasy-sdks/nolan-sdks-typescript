...
export class Workspace {
  ...
  async create(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CreateWorkspaceApiV1WorkspacesPostSecurity(
        security
      );
    }
    ...
    switch (true) {
      case httpRes?.status == 201:
        if (utils.matchContentType(contentType, `application/json`)) {
          res.createWorkspaceApiV1WorkspacesPost201ApplicationJSONAny =
            httpRes?.data;
        }
        break;
  ...
  async delete(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DeleteWorkspaceApiV1WorkspacesWorkspaceNameDeleteRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.DeleteWorkspaceApiV1WorkspacesWorkspaceNameDeleteSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async get(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetWorkspaceApiV1WorkspacesWorkspaceNameGetRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetWorkspaceApiV1WorkspacesWorkspaceNameGetSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async getStats(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetWorkspaceStatsApiV1WorkspacesWorkspaceNameStatsGetRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetWorkspaceStatsApiV1WorkspacesWorkspaceNameStatsGetSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    switch (true) {
      case httpRes?.status == 200:
        if (utils.matchContentType(contentType, `application/json`)) {
          res.workspaceStats = utils.objectToClass(
            httpRes?.data,
            shared.WorkspaceStats
          );
        }
        break;
      case httpRes?.status == 422:
  ...
  async list(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ListWorkspacesApiV1WorkspacesGetSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async searchCount(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.SearchCountApiV1WorkspacesWorkspaceNameSearchCountGetRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.SearchCountApiV1WorkspacesWorkspaceNameSearchCountGetSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
  ...
  async searchHistory(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.SearchHistoryApiV1WorkspacesWorkspaceNameSearchHistoryGetRequest(
          req
        );
    }
